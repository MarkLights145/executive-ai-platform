...
export function AddUserButton() {
  ...
  function copyCode() {
    ...
    navigator.clipboard.writeText(`${code}\n\nSign up at: ${url}\nClick "Sign up with invite code" and enter the code.`);
  }
      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="w-full max-w-md rounded-2xl border border-neutral-200 bg-white p-6 shadow-xl">
            <h3 className="text-lg font-semibold text-neutral-900">Invite a user</h3>
            <p className="mt-1 text-sm text-neutral-600">
              Generate a one-time code. Share it with the person; they sign up at the onboarding page and join your organization.
            </p>
            {error && (
            ...
            {!code ? (
              ...
              <div className="mt-6 space-y-4">
                <div className="rounded-xl border border-neutral-200 bg-neutral-50 px-4 py-3">
                  <p className="text-xs font-medium text-neutral-500">Invite code</p>
                ...
                <p className="text-sm text-neutral-600">
                  Send this code to the new user. They go to the onboarding page, click <strong>Sign up with invite code</strong>, enter the code, then complete name, email, password, and Telegram (optional).
                </p>
